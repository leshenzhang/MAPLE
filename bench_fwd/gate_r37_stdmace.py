...
No loadable periodic standard-MACE .pt exists in this sandbox (maceomol.pt absent;
macepol*.pt has a different 12-arg signature), so a runtime E/F parity gate on the
real model is IMPOSSIBLE here. What IS provable model-free: the edge builder is a
